...
/**
    ...
    private void initComponents() {
        ...
        cmbRol.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-", "ADMIN", "OFICIALES", " " }));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        if (validadorVentana.validarCampos(txtNom, "Ingrese su nombre de usuario") 
                ...
                || validadorVentana.validarComboBox(cmbRol, "-")) {
            ...
            String rolUsuario = (String) cmbRol.getSelectedItem();
            

            controller.crearUsuario(nomUsuario,contraUsuario,rolUsuario);
            
            JOptionPane.showMessageDialog(this, "Se creo el usuario con exito");
        }
    ...
    private void btnRegistrarMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnRegistrarMouseEntered
        btnRegistrar.setBackground(new Color(0x484848));
    ...
    private void btnRegistrarMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnRegistrarMouseExited
        btnRegistrar.setBackground(new Color(0x333333));
